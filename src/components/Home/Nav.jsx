...
import { BsSun, BsMoonStars, BsWindowSidebar } from "react-icons/bs";
import "./Home.css"
            ...
            <div className="navbar-left">
                <div className="navbar-logo">
                    <Link to="/home" onClick={(e)=>{e.preventDefault();
                        window.location.href="/home"}}><img src="https://res.cloudinary.com/dchjyy4cp/image/upload/v1740149240/Bondify/Assets/bondify-logo_aoip5y.png" alt="Logo" /></Link>
                </div>
